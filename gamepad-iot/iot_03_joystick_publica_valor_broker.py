...
def axisMotion():
    ...
    for  j in range(joystick_count):
        ...
        joy.init()
        for i in range(4):
            client.publish("joy{}/axis{}".format(j,i),joy.get_axis(i)) #"{}".format(joy.get_axis(i)))
            print("joy{}/axis{}".format(j,i),joy.get_axis(i))
...
def buttonPressed():
    for  j in range(joystick_count):
        ...
        joy.init()
        for i in range(12):
            client.publish("joy{}/but{}".format(j,i),joy.get_button(i)) #"{}".format(joy.get_axis(i)))
